...
export function createStubHandlers(): HandlerRegistry {
  ...
  return {
    ...
    ACCOUNT_SEND_SOLANA_TRANSACTION: notImplemented('ACCOUNT_SEND_SOLANA_TRANSACTION'),
    ACCOUNT_GET_BTC_ADDRESS: notImplemented('ACCOUNT_GET_BTC_ADDRESS'),
    ACCOUNT_GET_BTC_BALANCE: notImplemented('ACCOUNT_GET_BTC_BALANCE'),
    ACCOUNT_SEND_BTC_TRANSACTION: notImplemented('ACCOUNT_SEND_BTC_TRANSACTION'),
    ACCOUNT_GET_TON_ADDRESS: notImplemented('ACCOUNT_GET_TON_ADDRESS'),
    ACCOUNT_GET_TON_BALANCE: notImplemented('ACCOUNT_GET_TON_BALANCE'),
    ACCOUNT_SEND_TON_TRANSACTION: notImplemented('ACCOUNT_SEND_TON_TRANSACTION'),
    ACCOUNT_GET_TRON_ADDRESS: notImplemented('ACCOUNT_GET_TRON_ADDRESS'),
    ACCOUNT_GET_TRON_BALANCE: notImplemented('ACCOUNT_GET_TRON_BALANCE'),
    ACCOUNT_SEND_TRON_TRANSACTION: notImplemented('ACCOUNT_SEND_TRON_TRANSACTION'),
    ...
    SPARK_GET_ADDRESS: notImplemented('SPARK_GET_ADDRESS'),
    SPARK_GET_BALANCE: notImplemented('SPARK_GET_BALANCE'),
    SPARK_SEND: notImplemented('SPARK_SEND'),
    SPARK_GET_DEPOSIT_ADDRESS: notImplemented('SPARK_GET_DEPOSIT_ADDRESS'),
    SPARK_QUOTE_WITHDRAW: notImplemented('SPARK_QUOTE_WITHDRAW'),
    SPARK_WITHDRAW: notImplemented('SPARK_WITHDRAW'),
    LIGHTNING_CREATE_INVOICE: notImplemented('LIGHTNING_CREATE_INVOICE'),
    LIGHTNING_PAY_INVOICE: notImplemented('LIGHTNING_PAY_INVOICE'),
